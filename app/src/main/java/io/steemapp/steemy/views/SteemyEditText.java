 ...
 */
public class SteemyEditText extends EditText {

    private static final String ASSET_FOLDER = "fonts/";

    public SteemyEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        loadTypeface(context, attrs);
    }

    public SteemyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
